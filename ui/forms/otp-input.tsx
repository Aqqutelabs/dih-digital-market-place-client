    ...
    <div className="flex gap-3 justify-center">
      {Array.from({ length }).map((_, i) => (
        <input
          ...
          className="size-12 md:size-20 border border-[#D8D8D8] rounded-lg text-center text-2xl text-[#40DE58] font-semibold focus:outline-none focus:ring-2 focus:ring-[#27d642]"
        />
      ))}
    </div>
  );
